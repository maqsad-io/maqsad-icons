 ...
 * Outputs individual files per icon + a barrel index for tree-shaking support
 */
...
// No system icons found in assets/system/ directory
// Add SVG files to assets/system/stroke/ or assets/system/filled/
export {};
`;
    fs.writeFileSync(path.join(outputDir, 'index.tsx'), output);
    console.log('No system icons found');
    return;
  }

  // Generate individual files per icon for tree-shaking
  for (const [name, { content, svgStyle }] of icons) {
    ...
    let fileOutput = `// Auto-generated file - DO NOT EDIT MANUALLY
import { createSystemIcon } from '../../types';

export const ${componentName} = /* #__PURE__ */ createSystemIcon(
  '${componentName}',
...
`;
    ...
    fs.writeFileSync(path.join(outputDir, `${name}.tsx`), fileOutput);
  }

  // Generate barrel index file that re-exports from individual files
  let barrelOutput = `// Auto-generated file - DO NOT EDIT MANUALLY
// This file is generated by the build script from SVG sources
`;

  for (const [name] of icons) {
    const componentName = `Icon${toPascalCase(name)}`;
    barrelOutput += `export { ${componentName} } from './${name}';\n`;
  }

  fs.writeFileSync(path.join(outputDir, 'index.tsx'), barrelOutput);
  console.log(`Generated ${icons.size} system icons (individual files + barrel)`);
}
...
async function processIllustrationIcons(): Promise<void> {
  ...
  if (icons.size === 0) {
    const output = `// Auto-generated file - DO NOT EDIT MANUALLY
// No illustration icons found in assets/illustrations/ directory
// Add SVG files to assets/illustrations/primary/, secondary/, dark/, light/
export {};
`;
    fs.writeFileSync(path.join(outputDir, 'index.tsx'), output);
    console.log('No illustration icons found');
    return;
  }
  ...
  for (const [name, { variants: iconVariants }] of icons) {
    ...
    let fileOutput = `// Auto-generated file - DO NOT EDIT MANUALLY
import { createIllustrationIcon, type FilledColors } from '../../types';

export const ${componentName} = /* #__PURE__ */ createIllustrationIcon(
  '${componentName}',
  {
`;
...
`;
    ...
    fileOutput += `    filled: (${usesColors ? 'colors' : '_colors'}: FilledColors) => (
      <>${filledContent}</>
    ),
`;
...
`;
  ...
  fs.writeFileSync(path.join(outputDir, 'index.tsx'), barrelOutput);
  console.log(`Generated ${icons.size} illustration icons (individual files + barrel)`);
}
